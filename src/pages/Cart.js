        ...
        <div className='container mx-auto h-auto grid grid-cols-5 gap-8'>
            {
                    ...
                    products.map((item)=>(
                        ...
                        gap-6'>
                            <div className='w-full flex items-center justify-between gap-6'>
                                <div className='w-2/5'>
                                    <img className='w-full h-44 object-contain' src={item.image} alt='ProductImgs' />
                                </div>
                                <div className='w-1/5'>
                ...
                <div className='w-full h-72 bg-white col-span-1 flex flex-col justify-center items-center p-4'>
                <div>
                ...
                from-yellow-500 to-yellow-200 border hover:from-yellow-300 hover:to-yellow-400
                ...
                active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3'>Proceed to Pay</button>
                              ...
                              transition={{ delay: 0.5, duration: 0.5}} className='flex flex-col justify-center items-center gap-4 py-10'>
                    <div>
                    ...
                    shadow-lg'>
                        ...
                        <p className='text-sm text-center'>Your Shopping cart lives to serve. Give it purpose - fill it with
