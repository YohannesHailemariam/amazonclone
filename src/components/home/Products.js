...
const Products = () => {
  ...
  return (
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-4 gap-6 xl:gap-10 px-4'>
        {
            productData.map((item)=>(
                <div key={item.id} className='bg-white h-auto border-[1px] border-gray-200 py-8 z-30
                hover:border-transparent shadow-none hover:shadow-textShadow duration-200 flex 
